...
import { ShoppingBag, Loader2, Mail, Lock, Eye, EyeOff, User } from "lucide-react";
    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex flex-1 nexo-gradient-hero items-center justify-center p-12">
        ...
        >
          ...
          <h2 className="text-4xl font-bold mb-4">Únete a NexoShop</h2>
          <p className="text-xl text-primary-foreground/80 max-w-md">
            Crea tu cuenta y disfruta de ofertas exclusivas, envío rápido y miles de productos.
          </p>
        </motion.div>
      </div>
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full h-12 nexo-gradient-primary text-primary-foreground border-0 text-base mt-2"
            >
              {isLoading ? (
